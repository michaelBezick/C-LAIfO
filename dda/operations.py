...
from .functional import (shear_x, shear_y, translate_x, translate_y, hflip, vflip, rotate_img, invert, solarize, posterize,
...
class Rotate(_Operation):
    def __init__(self,
                 ...
                 debug: bool = False):
        super(Rotate, self).__init__(rotate_img, initial_magnitude, initial_probability, magnitude_range,
                                     probability_range, temperature, flip_magnitude=True,
                                     magnitude_scale=magnitude_scale, debug=debug)
