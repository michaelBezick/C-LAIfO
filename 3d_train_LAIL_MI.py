...
from DeepMind_control import dmc_3d, dmc_expert_3d
...
def make_env_expert(cfg):
    ...
    env = dmc_expert_3d.make_remastered_states_only(domain_name=domain,
                                                 task_name=task,
                                                 seed=cfg.seed,
...
class Workspace:
    ...
    def setup(self):
        ...
        self.train_env = dmc_3d.make_remastered(self.cfg.task_name_agent, self.cfg.frame_stack,
        ...
        self.eval_env = dmc_3d.make_remastered(self.cfg.task_name_agent, self.cfg.frame_stack,
                                            self.cfg.action_repeat, self.cfg.seed, self.cfg.visual_seed_target,
                                            self.cfg.vary, self.cfg.delta_target, self.cfg.image_height, self.cfg.image_width,
                                            self.cfg.depth_flag, self.cfg.segm_flag)
