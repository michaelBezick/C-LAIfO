...
from utils_folder.byol_multiset import BYOL, default, RandomApply
...
class LailByolAgent:
    ...
    def update_BYOL(self, obs, obs_e_raw, obs_random, obs_e_raw_random, check_every_steps, step):
        metrics = dict()

        loss = self.byol(obs, obs_e_raw, obs_random, obs_e_raw_random, self.CL_data_type, check_every_steps, step)
