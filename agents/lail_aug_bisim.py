...
class LailBisimAgent:
    ...
    def update_encoder(self, obs, action, reward, discount, next_obs):
        ...
        with torch.no_grad():
            ...
            pred_next_latent_mu2, pred_next_latent_sigma2, _ = self.transition_model(obs2, action)
        ...
        r_dist = F.smooth_l1_loss(reward, reward, reduction = 'none')
