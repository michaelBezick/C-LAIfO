...
class LailAgent:
    ...
    def update_encoder(self, z_a, next_z_a, z_e, next_z_e, z_a_random, next_z_a_random, z_e_random, next_z_e_random, check_every_steps, step):
        metrics = dict()
        ...
        loss = self.adaptive_penalty * mi_loss + self.mi_constant * mi_random_loss
    ...
    def update(self, replay_iter, replay_iter_expert, replay_iter_random, replay_iter_expert_random, step):
        ...
        metrics.update(self.update_encoder(z_a, 
                                           next_z_a, 
                                           z_e, 
                                           next_z_e, 
                                           z_a_random, 
